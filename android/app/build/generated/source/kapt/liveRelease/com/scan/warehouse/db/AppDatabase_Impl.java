  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `cached_products` (`barcode` TEXT NOT NULL, `skuId` INTEGER NOT NULL, `productName` TEXT NOT NULL, `categoryName` TEXT, `brandName` TEXT, `imageUrls` TEXT, PRIMARY KEY(`barcode`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '1921d9ef85688275a947631b6b11e890')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsCachedProducts.put("skuId", new TableInfo.Column("skuId", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "1921d9ef85688275a947631b6b11e890", "58ad5593c93477f383ac1899005c7603");
